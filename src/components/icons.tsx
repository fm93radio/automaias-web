...
// Fix: Add and export the missing QuoteIcon component.
export const QuoteIcon: React.FC = () => (
  <svg {...iconProps} strokeWidth="1.5" className="w-8 h-8">
...
export const ChatBubbleIcon: React.FC = () => (
  <svg {...iconProps}>
    <path {...strokeProps} d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72.235a1.125 1.125 0 01-1.086-1.086V15.75a.75.75 0 00-.75-.75h-4.5a.75.75 0 00-.75.75v3.75c0 .621-.504 1.125-1.125 1.125h-3.75a2.25 2.25 0 01-2.25-2.25v-6.75a2.25 2.25 0 012.25-2.25H6.75a.75.75 0 00.75-.75V7.5a2.25 2.25 0 012.25-2.25h7.5a2.25 2.25 0 012.25 2.25v1.5a.75.75 0 00.75.75h.75a.75.75 0 00.75-.75V8.25a.75.75 0 01.75-.75h.75a.75.75 0 01.75.75v.261z" />
  </svg>
);

export const TerminalIcon: React.FC = () => (
    <svg {...iconProps}>
        <path {...strokeProps} d="m4.5 12.75 3 3m0 0-3 3m3-3h15" />
        <path {...strokeProps} d="M4.5 5.25h15" />
        <path {...strokeProps} d="M4.5 9h15" />
        <path {...strokeProps} d="M4.5 16.5h15" />
    </svg>
);
